...
- [x] 公共 CI 提供可复现且固定版本的 Windows OpenCV/Clang 原生 feature job（OpenCV 4.13.0 + LLVM 20.1.8，代码基线 `04da4f2e3b66f24499b8f0e6a9dd5cbda6bdfc53` 的 CI run `34840255356` 已通过）；默认便携 job 仍不依赖机器专属原生工具链
